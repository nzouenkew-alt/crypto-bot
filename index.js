...
app.listen(PORT, () => {
  ...
  sendTelegram('🚀 Bot Crypto démarré! Surveillance du marché en cours. Vous recevrez une alerte quand un signal sera détecté.');
});
